...
class CardTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create card_type" do
    assert_difference('CardType.count') do
      post card_types_url, params: { card_type: { description: @card_type.description, name: @card_type.name } }
    end
  ...
  test "should update card_type" do
    patch card_type_url(@card_type), params: { card_type: { description: @card_type.description, name: @card_type.name } }
