...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post list_items_url, params: { list_item: { card_id: @list_item.card_id, description: @list_item.description, position: @list_item.position } }
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { card_id: @list_item.card_id, description: @list_item.description, position: @list_item.position } }
